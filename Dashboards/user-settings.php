                        ...
                        <form action="" method="POST">
                            <tr>
                                <td>
                                    ...
                                    <input type="current_username" name="current_username" id="current_username" placeholder="Current Username" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="new_username" name="new_username" id="new_username" placeholder="New Username" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="confirm_username" name="confirm_username" id="confirm_username" placeholder="Confirm Username" required>
                                </td>
                            </tr>
